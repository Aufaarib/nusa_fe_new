...
const FormPernyataanOrangTua = () => {
  const { parents, getParentsData, setErrMsg, errStep, stepsPMB, getStepsPMBData, formCheck, getFormCheck } = useStateContext();
  ...
  return(
    <>
      <Header category="PMB" title="Form Pernyataan Orang Tua" icon={<FaFileSignature />} />
