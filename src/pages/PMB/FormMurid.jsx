...
const FormMurid = () => {
  const { stepsPMB, students, getStudentsData, errStep, setErrMsg, getStepsPMBData, formCheck, getFormCheck } = useStateContext();
  ...
  return(
    <>
      <Header category="PMB" title="Form Pendaftaran Murid" icon={<FaChild />} />
