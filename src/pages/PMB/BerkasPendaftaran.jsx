...
const BerkasPendaftaran = () => {
  const { documents, getDocumentsData, setErrMsg, errStep, stepsPMB, getStepsPMBData, formCheck, getFormCheck } = useStateContext();
  ...
  const tabContent = () => {
    return (
      <FormBerkasPendaftaran key={indexMurid.toString()} indexMurid={indexMurid} />
    )
  }
  ...
  return(
    <>
      <Header category="PMB" title="Form Berkas Pendaftaran" icon={<AiFillFileText />} />
