        ...
        >
          <ColumnsDirective>
            ...
            <ColumnDirective
              ...
              headerText="Nama Lengkap Anak"
              width="200"
            />
            <ColumnDirective
              allowEditing={false}
              field="ayah.nama_lengkap"
              headerText="Nama Orang Tua"
              width="200"
            />
            <ColumnDirective
              allowEditing={false}
          ...
          <form className="grid mt-3 grid- cols-1 gap-7">
            <section>
              ...
              <UploaderComponent
                ...
                autoUpload={false}
                buttons={{
                  browse: !hasilTes.pdf ? "Unggah Berkas" : "Ganti Berkas",
                }}
              >
                {/* <FilesDirective>
