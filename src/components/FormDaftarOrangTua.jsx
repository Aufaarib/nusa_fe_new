...
const FormDaftarOrangTua = ({indexMurid}) => {
  ...
  const [parent, setParent] = useImmer({duplicate_data: false, id: "", step: 1, ayah: {}, ibu: {}, wali: {} });
...
>>>>>>> parent of 2b6e320 (update)
        ...
        {/* {(!parents[indexMurid].duplicate_data && parents[indexMurid].ayah.nama_lengkap == "" ) && ( */}
        {(indexMurid > 0 && parents[0].ayah.nama_lengkap !== "" ) && (
          <CheckBoxComponent label="Duplikat Data" data-name="duplicateDataOrtu" value={parents[indexMurid].duplicate_data} checked={parents[indexMurid].duplicate_data} cssClass="e-danger absolute -top-[42px] right-0" change={handleCheckbox.bind(this)}  />
        )}
...
<<<<<<< HEAD
        ...
        <form onSubmit={handleSubmit} className='relative grid mt-3 xs:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 lg:gap-7' >
          ...
          <section className='xs:col-span-3 lg:col-span-1 xs:mb-3 lg:mb-0'>
            ...
            <p className='text-xs'>Catatan : Untuk pertanyaan yang terdapat tanda bintang merah (<span className="text-merah">*</span>) wajib diisi.</p>
          </section>

          {/* COL 2 */}
          <section className='xs:col-span-3 lg:col-span-1'>
            <TextInput 
            ...
            <div className="flex flex-wrap">
              <label htmlFor="tanggal_lahir" className="flex w-full mt-4 mb-1 form-label">
                Tanggal Lahir Ayah<span className="ml-1 text-merah">*</span>
              </label>
              <DatePickerComponent 
                name="ayah"
                id="tanggal_lahir"
          ...
          <section className='xs:col-span-3 lg:col-span-1'>
            <div className="flex flex-wrap">
              <label htmlFor="pendidikan_terakhir" className="flex w-full mt-4 mb-1 form-label">
                Pendidikan Terakhir<span className="ml-1 text-merah">*</span>
              </label>
          ...
          <section className='xs:col-span-3 lg:col-span-1'>
            ...
            <div className="flex flex-wrap">
              <label htmlFor="tanggal_lahir" className="flex w-full mt-4 mb-1 form-label">
                Tanggal Lahir Ibu<span className="ml-1 text-merah">*</span>
              </label>
              <DatePickerComponent 
                name="ibu"
                id="tanggal_lahir"
          ...
          <section className='xs:col-span-3 lg:col-span-1'>
            ...
            <div className="flex flex-wrap">
              <label htmlFor="tanggal_lahir" className="flex w-full mt-4 mb-1 form-label">
                Tanggal Lahir Wali<span className="ml-1 text-merah">*</span>
              </label>
              <DatePickerComponent 
                name="wali"
                id="tanggal_lahir"
...
>>>>>>> parent of 2b6e320 (update)
        ...
        <section className='flex mt-12'>
          ...
          <div className='flex justify-end w-full'>
            <Link to={"/pmb/form-data-murid"} className="w-auto pl-0 mx-0 bg-transparent shadow-none btn-merah hover:bg-transparent text-merah hover:text-gelap">
              <BsChevronLeft className='text-xl m-0 mr-2 mt-0.5' /> Kembali
            </Link>

            <Link to={"/pmb/form-pernyataan"} className={`${openForm == "form_ortu_identitas" && "pointer-events-none text-gray-300"} w-auto pr-0 mx-0 bg-transparent shadow-none btn-merah hover:bg-transparent text-merah hover:text-gelap`}>
